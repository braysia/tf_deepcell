...
from tensorflow.contrib.keras.python.keras.layers import Dense, Flatten, Reshape, Activation
from tensorflow.contrib.keras.python.keras.layers import Conv2D, MaxPooling2D, GlobalMaxPooling2D
